...
import 'package:thmoviedb/bloc/get_persons_bloc.dart';
import 'package:thmoviedb/model/person.dart';
          ...
          return Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                  "Ternding for ${persons[index].known}",
                  style: TextStyle(
                    color: Style.Colors.titleColor,
